...
const ITEMS = [
    ...
    },
    {
        ...
        tipo:             'HITO',
        vertical:         'AIP',
        titulo:           'Push pendiente: fix isAdmin (commit 9d5e2c6) sin deploy a GitHub',
        descripcion:      'Commit 9d5e2c6 local (fix isAdmin CRM-BHUB-02) pendiente de push. Sin Vercel deploy activo hasta que llegue. Es el unico commit pendiente de push.',
        accion_propuesta: 'Director: cd 01_PRODUCTION\\AIP_v1.2.1 && git push origin main',
    ...
    },
    {
        ...
        referencia_disco: '03_INBOX/DEMIURGO_legacy_logs/tactical-logs/00_transversal/01_master_tasks.md',
        prioridad:        'P1',
        autonomia:        'Act',
        creado_por:       'SENTINEL',
        agente_asignado:  'Sentinel',
    ...
    },
    {
        ...
        tipo:             'TICKET',
        vertical:         'AIP',
        titulo:           '[RESUELTO] isAdmin usa array canonico de roles -- pendiente push',
        descripcion:      'Fix aplicado por Sentinel 2026-06-29 (commit 9d5e2c6): [ADMIN,DIRECTOR,superadmin,desk_manager] -> [superadmin,partner,desk_manager]. Pendiente: git push origin main (Director, terminal) para deploy Vercel.',
        accion_propuesta: 'Director: git push origin main en 01_PRODUCTION/AIP_v1.2.1 -- desbloquea Vercel. Luego marcar COMPLETADO en CRM.',
        referencia_disco: '01_PRODUCTION/AIP_v1.2.1/src/ignition-v13.js',
        prioridad:        'P1',
        autonomia:        'Alert',
        creado_por:       'SENTINEL',
        agente_asignado:  'Director',
